...
class CaterersPage extends StatefulWidget {
  ...
  @override
  State<CaterersPage> createState() => _CaterersPageState();
}
...
class _CaterersPageState extends State<CaterersPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Explore Caterers Collection"),
        actions: <Widget>[
          Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "Showing ${selectedCost.isNotEmpty ? selectedCost[0] : "None"} Caterers collection",
