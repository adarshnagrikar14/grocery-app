...
import 'package:demoapp/cust_cards/cust_card.dart';
...
class TissuePage extends StatefulWidget {
  ...
  const TissuePage({super.key, required this.type});

  @override
  State<TissuePage> createState() => _TissuePageState();
}

class _TissuePageState extends State<TissuePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("Explore $crockeryType collection"),
